...
from config.camera.PixelType_header import *
from config.camera.CameraParams_const import *
from config.camera.CameraParams_header import *
from config.camera.MvErrorDefine_const import *
...
def check_sys_and_update_dll():
    ...
    if currentsystem == 'Windows':
        ...
        MvCamCtrldllPath = r"MvCameraControl.dll"
